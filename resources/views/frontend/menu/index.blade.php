            ...
            <div class="lg:col-span-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach($allItems as $item)
                        <div class="menu-item-card bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-200 flex flex-col h-full">
                            <!-- 商品圖片 -->
