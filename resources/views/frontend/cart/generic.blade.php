                    ...
                    <div class="bg-white rounded-lg shadow-sm">
                                ...
                                <div class="p-6">
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm text-gray-500 mb-1">{{ $item['store_name'] ?? '未知店家' }}</p>
                                            ...
                                            <div class="flex items-center space-x-4">
                                                <div class="flex items-center border border-gray-300 rounded-lg">
                                                    <button onclick="updateQuantity({{ $item['id'] }}, {{ $item['quantity'] - 1 }})"
                                                            class="w-10 h-10 text-gray-600 hover:bg-gray-100 flex items-center justify-center transition-colors"
                                                            @if($item['quantity'] <= 1) disabled @endif>
                                                        <i class="fas fa-minus"></i>
                                                    </button>

                                                    <span class="w-16 text-center font-semibold text-gray-900">
                                                        {{ $item['quantity'] }}
                                                    </span>
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t">
                            <div class="flex justify-between items-center">
                                ...
                                <a href="{{ route('frontend.stores.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div class="text-sm text-blue-800">
                                        <p class="font-medium mb-1">多店家訂單</p>
                                        <p>您的購物車包含不同店家的商品，將分開結帳</p>
                                    </div>
                                </div>
                            </div>
                        </div>
