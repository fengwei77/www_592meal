...
<div class="container py-4">
            ...
            <div class="card border-primary">
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        ...
                        <a href="{{ route('filament.admin.resources.subscription-orders.index') }}"
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <a href="{{ route('filament.admin.pages.manage-subscription') }}" class="btn btn-outline-primary me-2">
            ...
            <a href="{{ route('filament.admin.resources.subscription-orders.index') }}" class="btn btn-outline-secondary">
